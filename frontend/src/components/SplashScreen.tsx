...
const promos = [
  ...
  },
  {
    ...
    title: '30天无限骑',
    subtitle: '月卡低至 ¥199',
    description: '通勤、出游、全天候畅享，比买单次省60%以上。',
    cta: '了解套餐',
    link: '/ride-packages',
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-sm mx-4 animate-fade-in-up">
        {/* Card */}
        <div className={`bg-gradient-to-br ${promo.gradient} rounded-3xl p-8 text-white shadow-2xl relative overflow-hidden`}>
          {/* Decorative circles */}
          ...
          <div className="relative">
            ...
            <p className="text-white/70 text-sm leading-relaxed mb-8">{promo.description}</p>
