...
export class ScooterController {
  ...
  @Get()
  @ApiOperation({ summary: '获取所有电动车', description: '获取系统中所有电动车的列表' })
  @ApiResponse({ 
    status: 200, 
    description: '获取成功',
    schema: {
  ...
  @Get(':id')
  @ApiOperation({ summary: '获取单个电动车', description: '根据ID获取电动车详细信息' })
  ...
  @ApiOperation({ summary: '创建电动车', description: '管理员创建新的电动车（需要管理员权限）' })
  ...
  @Patch(':id/status')
  @ApiBearerAuth('JWT-auth')
  @ApiOperation({ summary: '更新电动车状态', description: '管理员更新电动车状态（需要管理员权限）' })
  @ApiParam({ name: 'id', description: '电动车ID', example: 'clx1234567890' })
  ...
  @Delete(':id')
  @ApiBearerAuth('JWT-auth')
  @ApiOperation({ summary: '删除电动车', description: '管理员删除电动车（需要管理员权限）' })
  @ApiParam({ name: 'id', description: '电动车ID', example: 'clx1234567890' })
  @ApiResponse({ 
    status: 200, 
    description: '删除成功',
