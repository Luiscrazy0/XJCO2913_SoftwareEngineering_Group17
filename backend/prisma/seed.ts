  ...
  try {
    ...
    const xm4 = await prisma.booking.create({
      data: {
        ...
        hireType: HireType.HOUR_1,
        startTime: ago.d(5),
        endTime: new Date(ago.d(5).getTime() + 3600_000),
        actualStartTime: ago.d(5),
        actualEndTime: new Date(ago.d(5).getTime() + 3400_000),
    ...
    const zw4 = await prisma.booking.create({
      data: {
        ...
        hireType: HireType.HOUR_1,
        startTime: ago.d(8),
        endTime: new Date(ago.d(8).getTime() + 3600_000),
        actualStartTime: ago.d(8),
        actualEndTime: new Date(ago.d(8).getTime() + 3500_000),
        status: BookingStatus.COMPLETED,
        totalCost: 3.75,
      },
    });
